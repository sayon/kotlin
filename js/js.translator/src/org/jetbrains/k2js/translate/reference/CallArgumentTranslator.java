...
public class CallArgumentTranslator extends AbstractTranslator {
    ...
    @NotNull
    public static List<JsExpression> translateSingleArgument(@NotNull TranslationContext context,
        ...
        if (actualArgument instanceof VarargValueArgument) {
            return translateVarargArgument(context, valueArguments, shouldWrapVarargInArray);
        }
    ...
    @NotNull
    private static List<JsExpression> translateVarargArgument(@NotNull TranslationContext context,
    ...
    private void doTranslateArguments() {
        ...
        for (ValueParameterDescriptor parameterDescriptor : resolvedCall.getResultingDescriptor().getValueParameters()) {
            ...
            result.addAll(translateSingleArgument(context(), actualArgument, parameterDescriptor, !isNativeFunctionCall && !hasSpreadOperator));
        }
